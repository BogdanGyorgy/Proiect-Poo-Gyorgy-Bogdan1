    ...
    public class Administrator : User
    {
        ...
        public void RemoveClient(Library library, string username)
        {
            ...
            if (client != null)
            {
                ...
                Console.WriteLine($"Clientul '{client.Name}' a fost șters.");
            }
            else
            {
        ...
        public void ClearClientDebts(Library library, string username)
        {
            ...
            {
                client.Debts = 0;
                Console.WriteLine($"Datoriile clientului '{client.Name}' au fost șterse.");
            }
            else
            {
                Console.WriteLine("Clientul nu a fost găsit.");
        ...
        {
            Console.WriteLine("=== Istoric Împrumuturi ===");
        ...
        public void ViewClientLoanHistory(Library library, string username)
        {
            ...
            if (client != null)
            {
                Console.WriteLine($"=== Istoric Împrumuturi pentru {client.Name} ===");
        ...
        public void ViewTotalEarnings(Library library)
        {
            ...
            Console.WriteLine($"Câștiguri totale: {totalEarnings} RON");
        }
        ...
        public void ViewEarningsForPeriod(Library library, DateTime startDate, DateTime endDate)
        {
            ...
            Console.WriteLine($"Câștiguri pentru perioada {startDate:yyyy-MM-dd} - {endDate:yyyy-MM-dd}: {periodEarnings} RON");
        }
    }
    ...
    public class Client : User
    {
        ...
        public void BorrowBook(Library library, string isbn)
        {
            ...
            if (book != null && book.IsAvailable)
            {
                ...
                Console.WriteLine($"Cartea '{book.Title}' a fost împrumutată.");
            }
            else
            {
                Console.WriteLine("Cartea nu este disponibilă sau nu există.");
            }
        }
        ...
        public void ReturnBook(Library library, string isbn)
        {
            ...
            if (book != null && !book.IsAvailable)
            {
                ...
                Console.WriteLine($"Cartea '{book.Title}' a fost returnată.");
            }
            else
            {
                Console.WriteLine("Cartea nu este validă pentru returnare.");
            }
        }
